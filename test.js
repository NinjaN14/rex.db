...
console.log('Adding Numbers:', typeof db.math('myNumber', "+", 100) === 'number');
...
console.log('Subtracting from Numbers:', typeof db.math('myNumber', "-", 50) === 'number');
...
console.log(db.math('userInfo.balance', "+", 500));
